...
def predict():
    if request.method =='POST':
        ...
        if(modelCar =='Camry'):
            ...
            return render_template('index.html',prediction_text="Please enter a valid model")
        prediction = model.predict([[Mileage,age,Model_Camry,Model_Civic,Model_Corolla]])
        output = round(prediction[0],0)
        return render_template('index.html', prediction_text="The approximate value of this car is ${}.".format(output))
